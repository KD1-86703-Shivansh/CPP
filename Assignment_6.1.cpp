...
int main()
{
    ...
    cout << "Created employee object with parameterized constructor (1,100000,Sales,01,11,2000,'Mayank',01,5,1980) " << endl;
    Employee employee1(86655, 100000, "Sales", 01, 11, 2000, "Mayank", "Sunbeam Karad", 01, 05, 1980);
    cout << "Displaying employee object created using the parameterized contructor using the employee display member function. " << endl;
    employee1.display();
    cout << "\n\n-----------------------------------------\n\n";
